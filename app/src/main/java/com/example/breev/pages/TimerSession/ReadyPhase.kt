...
import com.example.breev.home.BreevBlob
...
fun Countdown(
    ...
    val breevSettings by viewModel.breevSettingsStore.data.collectAsState(
        initial = BreevSettings()
    )

    val countdownFrom = breevSettings.countdownFrom
...
fun RoundsRemainingText(
    ...
    val totalRounds = breevSettings.totalRounds
